...
def generate_launch_description():
    ...
    pkg_project_description = get_package_share_directory("jettec_robot")

    # load sdf file
    sdf_file = os.path.join(
        pkg_project_description, "model", "JetTec_Robot.sdf"
    )
    ...
    gz_sim = IncludeLaunchDescription(
        ...
        launch_arguments={
            "gz_args": PathJoinSubstitution(
                [pkg_project_description, "world", "Line_track.sdf"]
            )
        }.items(),
    )
